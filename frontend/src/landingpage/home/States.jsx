    ...
    <div className='container p-5'>
       <div className="row p-5">
        <div className="col-6 p-5">
          ...
          <h2 className='fs-4'>Ciustomer-first always</h2>
        ...
        <div className="col-6 p-5">
          <img src="src/images/ecosystem.png" style={{width:"90%"}}/>
          <div className='text-center'>
            <a href='' className='mx-5 'style={{textDecoration:"none"}}>Explore our Products<i class="fa-solid fa-arrow-right-long"></i></a>
                 <a href=''style={{textDecoration:"none"}}>Try Kiter Products<i class="fa-solid fa-arrow-right-long"></i></a>
          </div>
        </div>
       </div>
    </div>
